...
public class ControllerEnhanceInvocationHandler implements InvocationHandler {
    ...
    public ControllerEnhanceInvocationHandler(Object bean, boolean enhanceLogOpen) {
